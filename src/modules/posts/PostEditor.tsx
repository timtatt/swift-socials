...
import { getDefaultFormData, Template, templateSizes } from '@/common/types/template';
import { TemplatePreview } from '../templates/TemplatePreview';
import { TemplateForm } from './TemplateForm';
// TODO do html on server-side 
	...
	return (
		<>
			<Container fluid className="my-3">
				<Row>
					<Col md={4}>
						<TemplatePreview ref={previewRef} layoutProperties={formData} size={template.size ?? templateSizes['1200x1200']} layout={layout} style={template.style} />
					</Col>
					<Col>
